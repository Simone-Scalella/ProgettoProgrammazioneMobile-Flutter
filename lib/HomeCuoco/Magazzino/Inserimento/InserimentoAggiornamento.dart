...
/*
Questa è la schermata per l'inserimento di un' utilizzazione di un oggetto del magazzino
 */
class InserimentoAggiornamento extends StatelessWidget {
//Qui vengono definiti i controller per i TextField, per poter usare il testo che viene inserito dall'utente
  TextEditingController risorsa = TextEditingController();
...
//Questa è la funziona che esegue la chiamata al server
     Future<bool> getUserData() async {
      var response = await http.post(
          Uri.http("10.0.2.2", "progettolaurea/public/api/authed/aggiornamento/insert"),
          ...
          body: <String, String>{
            ...
            'data': data.text,
            'quantita': quantita.text,
            'magazzino': risorsa.text
          }
      );
