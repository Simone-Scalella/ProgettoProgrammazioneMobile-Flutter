...
/*
Questa è la schermata per l'inserimento di un trasferimento lavoro
 */
class InserimentoTrasferimentoLavoro extends StatelessWidget {
//Qui vengono definiti i controller per i TextField, per poter usare il testo che viene inserito dall'utente
  ...
  TextEditingController data_trasferimento = TextEditingController();
  TextEditingController valore_trasferito = TextEditingController();
  TextEditingController quantita_trasferita = TextEditingController();
...
//Questa è la funziona che esegue la chiamata al server
    Future<bool> getUserData() async {
      var response = await http.post(
          Uri.http("10.0.2.2", "progettolaurea/public/api/authed/gen/pro/trasferimento_lavoro/insert"),
          ...
          body: <String, String>{
            ...
            'data_trasferimento': data_trasferimento.text,
            'valore_trasferito': "-"+valore_trasferito.text,
            'quantita_trasferita': quantita_trasferita.text,
                  ...
                  Padding(
                    ...
                    child: TextField(
                      ...
                      InputDecoration(
                          ...
                          labelText: 'data trasferimento'
                      ),
                      controller: data_trasferimento,
                    ),
                  ),
                  Padding(
                    padding: EdgeInsets.all(16.0),
                    child: TextField(
                      ...
                      InputDecoration(
                          ...
                          labelText: 'Valore trasferito'
                      ),
                      controller: valore_trasferito,
                    ),
                  ),
                  Padding(
                    padding: EdgeInsets.all(16.0),
                    child: TextField(
                      ...
                      InputDecoration(
                          ...
                          labelText: 'Quantità trasferita'
                      ),
                      controller: quantita_trasferita,
                    ),
                  ),
                  Padding(
                    padding: EdgeInsets.all(16.0),
