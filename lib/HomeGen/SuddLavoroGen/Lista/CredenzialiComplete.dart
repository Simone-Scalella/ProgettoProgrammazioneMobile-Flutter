 ...
 */
class CredenzialiComplete extends StatelessWidget {
//Qui vengono definiti i controller per i TextField, per poter usare il testo che viene inserito dall'utente
  ...
  bool controllCF(String CodFis){
    if(CodFis == "" || CodFis.length > 16 || CodFis.length < 16) return false;
    else return true;
  }
            ...
            children: [
              ...
              Padding(
                  ...
                  child: ElevatedButton(
                    onPressed: () {
                      if(controllCF(dipendente.text)) {
                        FullData info = FullData(
                            risposta: credenziali, Input: dipendente.text);
                        FocusScope.of(context).unfocus();
                        Navigator.pushNamed(
                            context, 'ListaSuddivisioniGen', arguments: info);
                      }
