...
/*
Questa è la Home del dipendente generico
 */
class WelcomeGen extends StatelessWidget {
        ...
        body: Container(
          ...
          child: ListView(
            ...
            children: [
              ...
              ElevatedButton(
                onPressed: () {
                  Navigator.pushNamed(context, 'InserisciSuddivisione', arguments: credenziali);
                },
                child: Text('Inserisci una suddivisione lavoro'),
              ),
              ElevatedButton(
                onPressed: () {
                  Navigator.pushNamed(context, 'CodiceFiscale', arguments: credenziali);
                },
                child: Text('Visualizza ed elimina le suddivisioni lavoro'),
              ),
              ElevatedButton(
                onPressed: () {
